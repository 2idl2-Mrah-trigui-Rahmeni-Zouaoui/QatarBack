...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().
                ...
                .antMatchers("/token/*", "/api/joueurupdate/{id}/{ideq}").permitAll()
                .antMatchers("/token/*", "/api/addjoueur").permitAll()
                ...
                .antMatchers("/token/*", "/api/staff").permitAll()
                .antMatchers("/token/*", "/api/staffdelete/{id}").permitAll()
                .antMatchers("/token/*", "/api/staff/{id}").permitAll()
                .antMatchers("/token/*", "/api/staffadd").permitAll()
                .antMatchers("/token/*", "/api/staffupdate/{id}/{ide}").permitAll()
